...
export const API_ERRORS: any = {
  SIGN_UP: {
    ...
    NOT_WORK_EMAIL: 'Please provide a work email address',
    COMPANY_EXISTS:
      'Your company is already registered. At the moment, we support only one user per company',
  },
  LOGIN: {
...
export const FAILURE_BANK_CODE: any = {
  ...
  E_USER_CANCELLED: 'Netbanking could not be processed. Please try again.',
  E_USER_SESSION_EXPIRED:
    'Session has expired due to inacivity. Please try again.',
  E_WRONG_CREDENTIALS: 'Incorrect banking credentials. Please try again.',
  E_SYSTEM: 'Something went wrong.',
};
